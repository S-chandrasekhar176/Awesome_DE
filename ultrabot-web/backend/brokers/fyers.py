...
_transactional_limiter = RateLimiter(per_second=10, per_minute=200, per_day=10_000, name="fyers-transactional")
_data_limiter = RateLimiter(per_second=10, per_minute=200, per_day=100_000, name="fyers-data")
