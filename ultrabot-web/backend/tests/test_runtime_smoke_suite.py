...
class TestRuntimeSmokeSuite(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_02_risk_engine_16_gates(self):
        """Test all 16 risk gates including G11 drawdown with 0%."""
        config = {
        ...
        self.assertEqual(len(re.gates), 16, "RiskEngine must have exactly 16 gates")
        ...
        self.assertEqual(len(result.all_gates), 16)
        ...
        print(f"\n[SMOKE TEST 2 PASS] Risk Engine: Evaluated 16 gates successfully. G11 drawdown value={g11_result.value}% (passed={g11_result.passed})")
